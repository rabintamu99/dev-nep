...
const TrendPost: FC<TrendPostProps> = ({ initialPosts, subredditName }) => {
...
//     ['infinite-query'],
//     async ({ pageParam = 1 }) => {
//         const query = `/api/posts?sort=votes&order=desc&limit=${INFINITE_SCROLL_PAGINATION_RESULTS}&page=${pageParam}` +
//         (!!subredditName ? `&subredditName=${subredditName}` : '');
